        ...
        for _ in range(3):
            ...
            if r.status_code==200 and "application/json" not in ct:
                try:
                    ...
                    last_err=f"Request faied with status code 200:Could not decode image bytes:{e}"
                    break
...
def main():
    print("Welcome to the Post=Processing Magiv Workshop!")
    print("This program generates an image form text and applies post-processing effects.")
