...
def interactive_edge_detection(image_path):
    ...
    while True:
        ...
        if choice=="1":
            ...
            display_image("Laplacian Edge Detection",np.abs(laplacian),np.astype(np.uint8))
            ...
            display_image("Guassian  Smoothing",blurred)
            ...
            print("Invalid choice entered.Please select a number from 1 to 6.")
